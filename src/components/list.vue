...
<script>
import IconAddressPin from "../assets/IconAddressPin.png";
...
.listmap {
  ...
  box-shadow: 0 0.06rem 0,10rem rgba(0, 0, 0, 0.3);
  font-size: 14px;
